...
#
#             if show:
#                 save_path = '/home/bryanbed/Projects/RoMeLa_Vision/MaskTrackRCNN_static/outputs'
#                 model.module.show_result(data, result, dataset.img_norm_cfg,
#                                          dataset=dataset.CLASSES,
#                                          save_vis = True,
#                                          save_path = save_path,
...
def main():
    ...
    print("YTVOS annotations:", len(dataset.ytvos.anns))
    annot_list = dataset.load_annotations
    assert args.gpus == 1
    ...
    data_loader = build_dataloader(
        ...
        dist=False,
        shuffle=False)
    #args.save_path = '/home/bryanbed/Projects/RoMeLa_Vision/MaskTrackRCNN_static/outputs'
    ...
    if args.load_result:
        ...
        #outputs = single_test(model, data_loader, True, save_path=args.save_path)
